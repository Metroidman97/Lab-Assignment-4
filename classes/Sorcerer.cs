...
public class Sorcerer : Character
{
    ...
    public Sorcerer(string name, int level, string characterClass, int conScore, string race, bool hasTough, bool hasStout, bool hPAveraged) : base(name, level, characterClass, conScore, race, hasTough, hasStout, hPAveraged)
    {
